...
#' @return Data frame containing bait-prey pairs with the overlap score, a number between 0 and 1
...
#' @description Compute the overlap similarity scores for instances (e.g., bait-prey interactons (BPIs)) in the data.frame.
#' @export
