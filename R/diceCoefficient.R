#' diceCoefficient
#' @param datInput Data frame containing instances (e.g., bait-prey interactons (BPIs))
...
#' @description Compute the Dice similarity coefficient scores for instances (e.g., bait-prey interactons (BPIs)) in the data.frame.
#' @export
