...
#' @return Data frame containing bait-prey pairs with simpson coefficient, a number between 0 and 1
...
#' @description Compute the simpson similarity coefficient scores for instances (e.g., bait-prey interactons (BPIs)) in the data.frame.
#' @export
