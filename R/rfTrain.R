...
#' @param splitrule Splitrule rule for classificaton: 'gini', 'extratrees' or 'hellinger' with default 'gini'
...
#' @description Classification using the random forest (rf) algorithm.
